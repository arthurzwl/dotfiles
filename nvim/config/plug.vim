...
let g:Lf_RootMarkers = ['.git', '.hg', '.svn', '.vim']
...
" nmap <silent> vgd :call CocAction('jumpDefinition', 'vsplit')
...
Glaive codefmt google_java_executable="java -jar ~/soft/google-java-format-1.8-all-deps.jar"
